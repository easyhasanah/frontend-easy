  ...
  return (
    <div className="p-4">
      <div className="inline-block origin-top-left scale-[0.6] sm:scale-[0.75] md:scale-100 transition-transform duration-300">
        <div className="bg-gradient-to-r from-[#000000] to-[#4D4D4D] rounded-2xl text-white p-6 w-[320px] md:w-[350px] h-[200px] md:h-[220px] shadow-lg relative font-sans">
          {/* GOLD */}
          <div className="absolute top-4 right-6 text-sm font-medium">
            PLATINUM
          </div>
